...
class PantallaPrincipal(ctk.CTk):
    def __init__(self, db):
        ...
        # Botones del menú
        botones = [
            ("Registrar Habitación", self.abrir_registrar_auto),
            ("Registrar Cliente", self.abrir_registrar_cliente),
            ("Registrar Reserva", self.abrir_registrar_venta),
    ...
    def abrir_registrar_auto(self):
        # registrar_auto = RegistrarAuto(self.db)
        # registrar_auto.grab_set()
        pass
    ...
    def abrir_registrar_venta(self):
        # registrar_venta = RegistrarVenta(self.db)
        # registrar_venta.grab_set()
        pass
