...
class AsignarEmpleadoXHabitacion(ctk.CTkToplevel):
    def __init__(self, db):
        ...
        # Tamaño y configuración de la ventana utilizando WindowSizeHelper
    ...
    def crear_widgets(self):
        ...
        # Titulo
        ctk.CTkLabel(frame, text='Registrar Empleado Por Habitacion', font=("Arial", 18)).grid(row=0, column=0, columnspan=2, pady=20)
    ...
    def asignar_empleado_habitacion(self):
        ...
        try:
            ...
            messagebox.showinfo("Registro exitoso", "Se asigno el empleado a la habitacion correctamente")
            self.limpiar_campos()
